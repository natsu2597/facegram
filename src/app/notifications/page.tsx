...
import { HeartIcon, MessageCircleHeartIcon, UserPlusIcon } from 'lucide-react';
...
const getNotificationsIcon = (type : string) => {
  switch(type){
    case "LIKE" : 
    return <HeartIcon className='sixe-4 text-red-500' />
    case "COMMENT" : 
    return <MessageCircleHeartIcon className='size-4 text-blue-500' />
    case "FOLLOW" :
